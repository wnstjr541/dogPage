...
const GuaranteeCompanySlider = ({type}) => {
  const settings = {
  ...
  const tmpList2 = [
    {
      ...
      textList: [{ color: "#dd3737", text: "개1" }],
    },
    {
      img: "/images/dog/dog2.jpg",
      textList: [{ color: "#ef9421", text: "개2" }],
    },
    {
      img: "/images/dog/dog3.jpg",
      textList: [{ color: "#0ca700", text: "개3" }],
    },
    {
      img: "/images/dog/dog4.jpg",
      textList: [
        { color: "#dd3737", text: "개1" },
        { color: "#ef9421", text: "개2" },
        { color: "#0ca700", text: "개3" },
      ],
    },
    {
      img: "/images/dog/dog4.jpg",
